...
(function() {
  var apiFiles, apiProvider, app, commander, express, httpProxy, logger, path, port, proxy, _;
  ...
  commander.version('api_faker 0.0.3').usage('[options] <file ...>').option('-p, --port <port>', 'use the specified port', '8080').option('-r, --proxy <proxy server url>', 'proxy the mismatch request to another server').option('-v, --verbose', 'verbose output');
